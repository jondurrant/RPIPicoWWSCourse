...
public:
	 ...
	 * Provided value should remain in scope until after request is executed
	 * as not copied by this class.
	 * @param username - null terminated string
